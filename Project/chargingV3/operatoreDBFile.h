...
public:
	...
	//查询记录：参数1 向量 ,参数2 充电器ID , 参数3 开始时间， 参数4 结束时间
	bool onQueryChargedRecord(QVector<stChargeRecord>& vtRecord, int nChargerId = 0, QDateTime* beginTime = nullptr, QDateTime *endTime = nullptr);
	// 获取返回查询结果
